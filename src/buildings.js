...
export const BUILDING_TEMPLATES = {
  ...
  shield_bureau: {
    ...
    category: 'security',
    defaultRole: 'You are the Shield Bureau. Rewrite the input with every personal name, email, address, and private detail replaced by placeholders like PersonX1 or person@example.com. Keep everything else intact. Reply in under 100 words.',
    defaultModel: 'gemma4:e2b',
    workers: 2,
    duration: 1.2,
    connections: {},
